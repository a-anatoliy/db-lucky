...
-- Schema test_lucky
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `test_lucky` ;

-- -----------------------------------------------------
-- Schema test_lucky
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `test_lucky` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `test_lucky` ;
...
CREATE TABLE IF NOT EXISTS `ld_color_map` (
  ...
  `ld_color_id` TINYINT(1) NOT NULL,
  INDEX `fk_ld_color_map_ld_dresses1_idx` (`ld_dresses_id`),
  INDEX `fk_ld_color_map_ld_color1_idx` (`ld_color_id`),
