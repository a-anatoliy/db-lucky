...
-- `ld_carrency`
--
INSERT INTO `ld_currency` (`id`,`name`) VALUES (1,'PLN');

-- * -----------------------------------------------
--
-- `ld_size`
--
INSERT INTO `ld_size` (`id`,`name`) VALUES
  (1,'0 (XS)'),(2,'2 (XS)'),(3,'4 (S)'),(4,'6 (S)'),(5,'8 (M)'),
  (6,'10 (M)'),(7,'12 (L)'),(8,'14 (L)'),(9,'16 (XL)')
;
...
-- `ld_color`
--
INSERT INTO `ld_color` (`id`,`name`) VALUES
  (1,'white'),(2,'ivory'),(3,'soft white'),(4,'gold'),(5,'silver')
;
...
-- `ld_collection`
--
INSERT INTO `ld_collection` (id, name) VALUES (null ,'2017'), (null ,'2018'),  (null ,'2019'),  (null ,'Other');
...
INSERT INTO `ld_dress_images` (id, path, name, width, height, is_active, dress_id) VALUES
  ...
  (null ,'/i/dress/2018/002','_R7A1136.jpg',600,900,1,2),
...
-- --------------------------------------------------
-- size(size_map)
INSERT INTO `ld_size_map` (dress_id, size_id) VALUES (1,3),(1,5);
INSERT INTO `ld_size_map` (dress_id, size_id) VALUES (2,2),(2,4),(2,3);
INSERT INTO `ld_size_map` (dress_id, size_id) VALUES (3,1),(3,3);
-- collection(collection_map)
INSERT INTO `ld_collection_map` (dress_id, collection_id) VALUES (1,2);
INSERT INTO `ld_collection_map` (dress_id, collection_id) VALUES (2,2);
INSERT INTO `ld_collection_map` (dress_id, collection_id) VALUES (3,2);
-- color(color_map)
INSERT INTO `ld_color_map` (dress_id, color_id) VALUES (1,1),(1,3),(1,5);
INSERT INTO `ld_color_map` (dress_id, color_id) VALUES (2,1),(2,2),(2,3);
INSERT INTO `ld_color_map` (dress_id, color_id) VALUES (3,4),(3,3),(3,5);
-- currency(currency_map)
INSERT INTO `ld_currency_map` (dress_id, currency_id) VALUES (1,1);
INSERT INTO `ld_currency_map` (dress_id, currency_id) VALUES (2,1);
INSERT INTO `ld_currency_map` (dress_id, currency_id) VALUES (3,1);
-- dress inserting DONE --
--
...
'<div>Back zip with hook-and-eye closure; covered buttons<br>Polyester; polyester lining<br>Bust cups; boning<br>Professionally clean<br>Imported<br>We recommend pairing this gown with a veil in ivory<br>All gowns and select bridal apparel items require an additional shipping charge of $15</div>',
5378,NULL,NULL,NULL,4,4,,NOW,1,1);
...
Зинаида (греч.)  рожденная Зевсом, из рода Зевса<br /> Злата (слав.)  богиня Зари
